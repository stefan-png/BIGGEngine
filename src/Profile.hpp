...
#define _BIGG_PROFILE_CATEGORY_NAME(_line, _category, _name) BIGGEngine::ScopedTimer BIGG_CAT_(timer, _line)([&, prettyFunction = BX_FUNCTION](double startTime, double delta) {BIGGEngine::Log::m_profileLogger->debug("\"cat\": \"{:s}\", \"ts\": {:f}, \"dur\": {:f}, \"name\": \"{:s}\"", _category, startTime*1e6, delta*1e6, _name);})
